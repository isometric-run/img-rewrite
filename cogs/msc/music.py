...
class DisPlayer(Player):
    ...
    async def invoke_player(self, ctx: commands.Context = None) -> None:
        ...
        embed = discord.Embed(title=track.title, url=track.uri, color=coloring.GRAY)
...
class Check:
    ...
    async def userInVoiceChannel(self, ctx, bot):
        ...
        hacker5 = discord.Embed(
            title="",
            description=
            f"<:error:1018174714750976030> {ctx.author.mention} You are not connected in a voice channel",
            color=coloring.GRAY)
    ...
    async def botInVoiceChannel(self, ctx, bot):
        ...
        hacker5 = discord.Embed(
            title="",
            description=
            f"<:error:1018174714750976030> {ctx.author.mention} I'm not connected in a voice channel",
            color=coloring.GRAY)
        hacker5.set_footer(text=f"Requested By {ctx.author}",
                           icon_url=f"{ctx.author.avatar}")
        hacker5.set_thumbnail(url=f"{ctx.author.avatar}")
    ...
    async def botNotInVoiceChannel(self, ctx, bot):
        ...
        hacker5 = discord.Embed(
            title="",
            description=
            f"<:error:1018174714750976030> I'm already connected in a voice channel",
            color=coloring.GRAY)
        hacker5.set_footer(text=f"Requested By {ctx.author}",
                           icon_url=f"{ctx.author.avatar}")
        hacker5.set_thumbnail(url=f"{ctx.author.avatar}")
    ...
    async def userAndBotInSameVoiceChannel(self, ctx, bot):
        ...
        hacker5 = discord.Embed(
            title="",
            description=
            f"<:error:1018174714750976030> You are not connected in the same voice channel that the bot",
            color=coloring.GRAY)
        hacker5.set_footer(text=f"Requested By {ctx.author}",
                           icon_url=f"{ctx.author.avatar}")
        hacker5.set_thumbnail(url=f"{ctx.author.avatar}")
    ...
    async def botIsPlaying(self, ctx, bot):
        ...
        hacker5 = discord.Embed(
            title="",
            description=
            f"<:error:1018174714750976030> There is currently no song to replay",
            color=coloring.GRAY)
        hacker5.set_footer(text=f"Requested By {ctx.author}",
                           icon_url=f"{ctx.author.avatar}")
        hacker5.set_thumbnail(url=f"{ctx.author.avatar}")
...
#<:volume_down:1056039813712707654>
    ...
    @discord.ui.button(emoji="<:volumedown:1060035696477356032>",
    ...
    async def volume_button(self, interaction: discord.Interaction,
        ...
        if player.is_playing:
            ...
            hacker2 = discord.Embed(
                description=
                f"I am not playing anything.",
                color=coloring.GRAY)
            return await interaction.response.send_message(embed=hacker2,
                                                           ephemeral=True)

    @discord.ui.button(emoji="<:astroz_rewind:1060035624314339349>",
                       style=discord.ButtonStyle.grey,
                       row=0)
    async def seek_button(self, interaction: discord.Interaction,
        ...
        if player.is_playing:
            ...
            hacker1 = discord.Embed(
                description=
                "Seeked the current player to `10 seconds` .",
                color=coloring.GRAY)
            return await interaction.response.send_message(embed=hacker1,
                                                           ephemeral=True)
        else:
    ...
    @discord.ui.button(emoji="<:stop:1060035564516167720>",
    ...
    @discord.ui.button(emoji="<:_next:1060035602084544542>",
                       style=discord.ButtonStyle.grey,
                       row=0)
    ...
    @discord.ui.button(emoji="<:volume:1060035741566124062>",
                       style=discord.ButtonStyle.grey,
                       row=0)
    async def vol_button(self, interaction: discord.Interaction,
        ...
        if player.is_playing:
            ...
            hacker1 = discord.Embed(
                description=
                "Successfully changed player volume to : `100`",
                color=coloring.GRAY)
            return await interaction.response.send_message(embed=hacker1,
                                                           ephemeral=True)
        else:
...
class Music(commands.Cog):
        ...
        if 'https://open.spotify.com' in str(search):
            ...
            if vc.queue.is_empty and not vc.is_playing():
                ...
                mbed = discord.Embed(
                    color=coloring.GRAY,
                    description=
                    f"[{track.title}](https://cover.icey.fr)"
                )
                # mbed.add_field(name="", value=f"[{track.title}]()")
                # mbed.add_field(name="<:jk_users:1045213273273929738> Requested By", value=f"{ctx.author.mention}")
                mbed.add_field(name="Song By",
                               value=f"`{track.author}`")
                mbed.add_field(name="Duration",
                ...
                embed = discord.Embed(
                    description=
                    f'[{track}](https://cover.icey.fr) Added To The Queue',
                    color=coloring.GRAY)
            ...
            if vc.queue.is_empty and not vc.is_playing():
                ...
                mbed = discord.Embed(
                    color=coloring.GRAY,
                    description=
                    f"[{track1}](https://cover.icey.fr)"
                )
                mbed.add_field(name="Song Url", value=search)
                # mbed.add_field(name="", value=f"[{track1}](https://cover.icey.fr)")
                mbed.set_author(name="Now Playing",
                                icon_url=f"{ctx.author.avatar}")
                mbed.set_thumbnail(url=self.bot.user.display_avatar.url)
                mbed.set_footer(text=f"Requested By {ctx.author}",
                ...
                embed = discord.Embed(
                    description=
                    f'[{track1}](https://cover.icey.fr) Added To The Queue',
                    color=coloring.GRAY)
            ...
            if vc.queue.is_empty and not vc.is_playing():
                ...
                mbed = discord.Embed(
                    color=coloring.GRAY,
                    description=
                    f"[{track2.title}](https://cover.icey.fr)"
                )
                #mbed.add_field(name="", value=f"[{track2.title}](https://cover.icey.fr)")
                #mbed.add_field(name="<:jk_users:1045213273273929738> Requested By", value=f"{ctx.author.mention}")
                mbed.add_field(name=" Song By",
                ...
                embed = discord.Embed(
                    description=
                    f'[{track2}](https://cover.icey.fr) Added To The Queue',
                    color=coloring.GRAY)
        ...
        if not player.queue.is_empty:
            ...
            if hasattr(new_song, 'thumb'):
                mbed = discord.Embed(
                    color=coloring.GRAY,
                    description=
                    f"[{new_song.title}](https://cover.icey.fr)"
                )
                #mbed.add_field(name="", value=f"[{new_song.title}](https://cover.icey.fr)")
                #mbed.add_field(name="<:jk_users:1045213273273929738> Requested By", value=f"{ctx.author.mention}")
                mbed.add_field(name=" Song By",
    ...
    async def connect(self,
        ...
        if channel is None:
            ...
            av = discord.Embed(
                description=
                f"I am already connected to a voice channel.",
                color=coloring.GRAY)
        ...
        sc = discord.Embed(
            description=
            f"Successfully connected to {channel.mention}.",
            color=coloring.GRAY)
    ...
    async def leave_command(self, ctx: commands.Context):
        ...
        hacker1 = discord.Embed(
            description=
            f"Successfully disconnected from {ctx.author.voice.channel.mention}",
            color=coloring.GRAY)
    ...
    async def skip_command(self, ctx: commands.Context):
        ...
        if player.is_playing:
            ...
            hacker1 = discord.Embed(
                description=
                f"Successfully Skipped the track .",
                color=coloring.GRAY)
    ...
    async def pause_command(self, ctx: commands.Context):
        ...
        if not player.is_paused():
            if player.is_playing():
                ...
                hacker1 = discord.Embed(
                    description=
                    f"Successfully paused the player .",
                    color=coloring.GRAY)
                view = Buttons()
                await ctx.send(embed=hacker1)
            else:
    ...
    async def resume_command(self, ctx: commands.Context):
        ...
        if player.is_paused():
            ...
            hacker1 = discord.Embed(
                description=
                f"Successfully resumed the player .",
                color=coloring.GRAY)
    ...
    async def boost_command(self, ctx: commands.Context):
        ...
        hacker4 = discord.Embed(
            description=
            "Successfully enabled `bass boost` .",
            color=coloring.GRAY)
    ...
    async def rmvboost_command(self, ctx: commands.Context):
        ...
        hacker4 = discord.Embed(
            description=
            "Successfully disabled `bass boost` .",
            color=coloring.GRAY)
        await ctx.reply(embed=hacker4)
    ...
    async def volume(self, ctx, volume):
        ...
        hacker4 = discord.Embed(
            description=
            f"Successfully changed player volume to : `{volume}%`",
            color=coloring.GRAY)
    ...
    async def playing(self, ctx):
        ...
        em = discord.Embed(
            description=f"[{vc.track}](https://cover.icey.fr)",
            color=coloring.GRAY)

        em.add_field(name=" Song By",
    ...
    async def shuffle(self, ctx):
        ...
        hacker2 = discord.Embed(
            description=
            "Successfully shuffled the current queue .",
            color=coloring.GRAY)
    ...
    async def pull(self, ctx, index: int):
        ...
        if index > len(vc.queue) or index < 1:
            hacker2 = discord.Embed(
                description=
                f"Must Be Between 1 And {len(vc.queue)} .",
                color=coloring.GRAY)
            return await ctx.reply(embed=hacker2)
        ...
        hacker3 = discord.Embed(
            description=
            f"Successfully pulled out `{removed.title}` From Queue .",
            color=coloring.GRAY)
    ...
    async def _queue(self, ctx):
        if not ctx.voice_client:
            ...
            hacker1 = discord.Embed(
                description=
                "You need to join a voice channel to play something .",
                color=coloring.GRAY)
            return await ctx.send(embed=hacker1)
        else:
            vc: wavelink.Player = ctx.voice_client
        ...
        hacker4 = discord.Embed(title="Music | Queue", color=coloring.GRAY)
        ...
        for song in copy:
            ...
            hacker4.add_field(name=f"Position : {count}",
                              value=f"[{song.title}](https://cover.icey.fr/)")
    ...
    async def _clear(self, ctx):
        ...
        hacker3 = discord.Embed(
            description=
            f"Successfully Clears The current Queue .",
            color=coloring.GRAY)
        hacker3.set_footer(text=f"Requested By {ctx.author}",
                           icon_url=f"{ctx.author.avatar}")
        return await ctx.send(embed=hacker3)
    ...
    async def seek_command(self, ctx, position: str):
        ...
        hacker3 = discord.Embed(
            description=
            f"Successfully Seeked the current player to {secs} .",
            color=coloring.GRAY)
